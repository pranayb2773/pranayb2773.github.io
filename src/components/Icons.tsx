...
export function GithubIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`fill-current ${className}`}>
      <title>GitHub</title>
...
export function TerminalIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className={className}>
...
export const projectIcons: Record<string, React.FC<IconProps>> = {
  folder: FolderIcon,
